...
-- cat shard-magic.sql | docker exec -i highload-homework-20_postgresql-b_1 psql postgresql://postgres:postgres@postgresql-b:5432/postgres
-- type shard-magic.sql | docker exec -i highload-homework-20_postgresql-b_1 psql postgresql://postgres:postgres@postgresql-b:5432/postgres
