...
-- cat simple-db.sql | docker exec -i highload-homework-20_postgresql-b_1 psql postgresql://postgres:postgres@postgresql-b:5432/postgres
-- type simple-db.sql | docker exec -i highload-homework-20_postgresql-b_1 psql postgresql://postgres:postgres@postgresql-b:5432/postgres
